module Api::V1
  class ChecksController < ApplicationController
    ...
    def check_params
      ...
      params.require(:check).permit(:id, :target, :status, :options, :webhook, :agent_id, :checktype_id, :checktype_name, :progress, :raw, :report, :scan_id, :jobqueue_id, :jobqueue_name, :tag, :required_vars => [])
    end
