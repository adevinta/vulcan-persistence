class Check < ApplicationRecord
  @@allowed_trasitions = {
    :CREATED => [:QUEUED, :ASSIGNED, :MALFORMED, :RUNNING, :FAILED, :FINISHED, :ABORTED,:PURGING, :KILLED, :TIMEOUT],
    :QUEUED => [:ASSIGNED, :MALFORMED, :RUNNING, :FAILED, :FINISHED, :ABORTED,:PURGING, :KILLED, :TIMEOUT],
    :ASSIGNED => [:MALFORMED, :RUNNING, :FAILED, :FINISHED, :ABORTED,:PURGING, :KILLED, :TIMEOUT],
    :RUNNING => [:MALFORMED, :FAILED, :FINISHED, :ABORTED,:PURGING, :KILLED, :TIMEOUT]
  }
